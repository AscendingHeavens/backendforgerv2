...
const About = () => {
  return (
    <section id="about" className=" bg-background py-12 flex w-full flex-col items-center px-6">
      <p className="font-poppins text-xl md:text-2xl font-bold mb-5">About us</p>
      <p className="flex flex-col md:flex-row gap-2 font-nunito text-4xl md:text-5xl font-bold items-center text-center md:text-left">
        <Star width={50} />
        It’s not about ideas. It’s about making ideas happen.
        <Star width={50} rotate={110} />
      </p>
      <div className="flex flex-col md:flex-row w-full px-6 md:px-28 gap-6 md:gap-10 mt-4">
        <p className="w-full text-justify mt-6 md:mt-10 font-poppins text-lg md:text-xl">
